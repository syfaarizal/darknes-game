 ...
 */
export function IdentityLayout({ children, onClick }: IdentityLayoutProps) {
  return (
    <div
      className="relative flex h-screen w-screen items-center justify-center overflow-hidden bg-[var(--color-void)]"
      onClick={onClick}
    >
